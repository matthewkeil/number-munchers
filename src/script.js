...
class Board {
    ...
    constructor() {
        ...
        for (let i = 0; i < this._rows; i++) {
            this._element.append(this.buildRow(this._cols, i));
        }
        // displayExtraLives();
    }
    ...
    buildCell(rowIndex, colIndex) {
        ...
        cell.className = "cell";
        cell.innerHTML = `<h3>${3}</h3>`
    
        return cell;
    }


    buildRow(numCols, rowIndex) {
...
class Muncher {
    ...
    munch() {
        ...
        console.log(this._board.find(cell + ' h3').text())
        this._board.find(cell).html('');
    }
}
